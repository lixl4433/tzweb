(function() {
    ...
    src, m, baseurl = "/test/common/supermap/";
    ...
    //加载类库资源文件
    function loadSMLibs() {
        inputScript(baseurl+'libs/SuperMap-8.1.0-14126.js');
        loadLocalization();
        inputCSS('style.css');
        inputCSS('google.css');
    }
    ...
    function loadLocalization() {
        ...
        if(userLang.indexOf('zh') > -1){
            inputScript(baseurl + 'libs/Lang/zh-CN.js');
        }else{
            inputScript(baseurl + 'libs/Lang/en.js');
        }
    }
