    ...
    $.fn.lyGrid = (function(options) {
        ...
        var fenyeDiv = function(jsonData) {
            ...
            if (String(conf.selectPage) == "true") {
                ...
                lia_8_span.setAttribute("style", "padding: 4px 10px;margin-right: 5px;");
        ...
        var datatree = function() {
            ...
            if (img.className.indexOf("fa fa-arrows-h") > -1) {
            	var dtr = $(ttrd).find(".fa.fa-arrows-h");
            	dtr.each(function() {
            		this.className = "fa fa-arrows";
                });
            	...
            	var dtr = $(ttrd).find(".fa.fa-arrows");
            	dtr.each(function() {
            		this.className = "fa fa-arrows-h";
                });
                for (var m = 0; m < 20; m++) {
