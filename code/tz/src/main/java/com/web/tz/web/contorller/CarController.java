...
public class CarController {
	...
	public String listUI() {
		return ForwardConstants.CAR + ForwardConstants.LIST;
	}
	...
	public PageView page_list(String pageNow, String pageSize, String column, String sort) {
		...
		List<Car> datas = carMapper.find_page(String.valueOf(begin), String.valueOf(page_size));
		PageView pv = new PageView();
		pv.setRecords(datas);
		pv.setPageNow(Integer.parseInt(pageNow));
		int data_size = carMapper.data_count();
